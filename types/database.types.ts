// Generated by: npx supabase gen types typescript --project-id YOUR_PROJECT_ID > types/database.types.ts
// Replace this file with real generated types after applying database/schema.sql to your Supabase project.
